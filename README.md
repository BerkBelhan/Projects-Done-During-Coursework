...
1. Scrape product and seller data
2. Analyze reviews and descriptions using investigator agents
3. Aggregate findings using a final judge agent
4. Generate:
...
Reasoning:
- Multiple reviews report non-delivery
- Seller account is newly created
- Product description contains suspicious inconsistencies
```
